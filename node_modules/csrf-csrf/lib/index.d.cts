...
declare function doubleCsrf({ getSecret, getSessionIdentifier, cookieName, cookieOptions: { sameSite, path, secure, ...remainingCookieOptions }, size, ignoredMethods, getTokenFromRequest, errorConfig: { statusCode, message, code, }, }: DoubleCsrfConfigOptions): DoubleCsrfUtilities;
